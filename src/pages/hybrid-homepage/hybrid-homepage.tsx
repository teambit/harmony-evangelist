...
export class HybridHomepage extends PureComponent<HybridHomepageProps> {
  render() {
    const { communityScopes = null, mainCta, githubStars, onBookMeeting, className, ...rest } = this.props;

    return (
      <div {...rest} className={classNames(backgrounds.bedrock, className)}>
        <div className={classNames(styles.purpleBackground, styles.purpleFold, styles.margin180)}>
          <Hero className={classNames(styles.landingSection)} onBookMeeting={onBookMeeting} />
        ...
        <div className={classNames(styles.greyBackground, styles.greyBgPadding, styles.foldMargin)}>
        ...
        <TalkToExperts className={classNames(centerColumn, styles.foldMargin)} onBookMeeting={onBookMeeting} />
        ...
        <CommunitySection className={classNames(centerColumn, styles.foldMargin)} githubStars={githubStars} />
