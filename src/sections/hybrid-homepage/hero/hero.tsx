...
export function Hero({ onBookMeeting, ...rest }: ReuseLandingProps) {
  return (
    <div data-bit-id="teambit.evangelist/sections/hero" {...rest}>
      <Grid colL={2} className={classNames(styles.mainGrid, text.center, text.l.left)}>
        <div>
          <div>
            ...
            <Paragraph size={PossibleSizes.lg} className={classNames(styles.paragraph, textColumn, marginCenter)}>
              Bit is the platform for component-driven development. Forget monoliths and distribute app development to
              components. Enjoy better scale, speed, and consistency. Join 200k+ developers and start free.
            </Paragraph>
          </div>
          ...
          <Paragraph size={PossibleSizes.sm} element="div" className={classNames(styles.buttons)}>
            ...
            <Button elevation="medium" onClick={onBookMeeting}>
              Book a Demo
            </Button>
            {/* </Link> */}
          </Paragraph>
        ...
        <Image src="homepage-bit/process-2.svg" className={marginCenter} alt="illustration" fullWidth />
      </Grid>
    </div>
  );
}
